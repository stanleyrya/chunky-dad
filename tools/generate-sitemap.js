...
function buildSitemap() {
  ...
  // The bear-runs calendar: every run on one month view, generated by
  // tools/generate-city-pages.js alongside the cities
  if (fs.existsSync(path.join(ROOT, 'bear-runs', 'index.html'))) {
    urls.push({
      loc: `${BASE_URL}/bear-runs/`,
      lastmod: lastmod,
      changefreq: CHANGE_FREQ.city,
      priority: PRIORITIES.city
    });
