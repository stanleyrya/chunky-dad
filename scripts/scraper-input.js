...
const scraperCities = (() => {
  if (typeof window === 'undefined' && typeof require !== 'undefined') {
    return require('./scraper-cities.js');
  }

  if (typeof window === 'undefined' && typeof importModule !== 'undefined') {
    return importModule('scraper-cities');
  }

  if (typeof window !== 'undefined' && window.scraperCities) {
    return window.scraperCities;
  }

  throw new Error('scraper-cities configuration not found. Ensure scraper-cities.js is available.');
})();
