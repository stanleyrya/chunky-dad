  ...
  parsers: [
    ...
    },
    {
      ...
      fieldPriorities: {
        ...
        shortName: { priority: ["static"], merge: "upsert" },
        instagram: { priority: ["static"], merge: "clobber" },
        description: { priority: ["ai-web", "static"], merge: "clobber" },
        bar: { priority: ["ai-web", "static"], merge: "clobber" },
        address: { priority: ["ai-web", "static"], merge: "clobber" },
        startDate: { priority: ["ai-web", "static"], merge: "clobber" },
        endDate: { priority: ["ai-web", "static"], merge: "clobber" },
        url: { priority: ["ai-web", "static"], merge: "clobber" },
        location: { priority: ["ai-web", "static"], merge: "clobber" },
        ticketUrl: { priority: ["ai-web", "static"], merge: "clobber" },
        gmaps: { priority: ["ai-web", "static"], merge: "clobber" },
        image: { priority: ["ai-web", "static"], merge: "clobber" },
        cover: { priority: ["ai-web", "static"], merge: "clobber" }
      },
      metadata: {
        title: { value: "FURBALL" },
