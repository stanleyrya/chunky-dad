...
const AI_PROMPT_FIELDS = [
    ...
    { param: 'cover',   desc: 'Exact cover/admission/ticket price text from source (e.g. Free, $15, $15-$25). May be a range, omit if not stated. Do not include "FREE" unless explicitly in source text.' }
];
