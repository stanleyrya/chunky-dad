...
class BearEventScraperOrchestrator {
    ...
    async run() {
        try {
            ...
            // Create adapter instance first to load configuration
            ...
            // Create shared core instance with city mappings from config
            console.log("🐻 Orchestrator: Creating shared core instance with city mappings...");
            const sharedCore = new this.modules.SharedCore(config.cityMappings || {});
