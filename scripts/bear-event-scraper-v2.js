// Bear Event Scraper V2 for Scriptable
// Enhanced version combining best features from both implementations
// Auto-checks websites, parses events, syncs to Google Calendars with improved accuracy
...
class BearEventScraperV2 {
    constructor() {
        ...
        // Configuration files
        this.CONFIG_FILE = "bear-event-scraper-v2-config.json";
        this.INPUT_FILE = "bear-event-parser-input.json";
        this.LOG_FILE = "bear-event-scraper-v2-logs.txt";
        this.PERFORMANCE_FILE = "bear-event-scraper-v2-performance.csv";
    ...
    generateReport(results) {
        ...
        const reportPath = fm.documentsDirectory() + `/bear-event-scraper-v2-report-${timestamp}.txt`;
