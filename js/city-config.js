...
// The city switcher on generated pages is static HTML; prune the quiet
// cities out of it at load so it matches the homepage.
if (typeof document !== 'undefined') {
    document.addEventListener('DOMContentLoaded', () => {
        document.querySelectorAll('.city-option[data-city-key]').forEach(a => {
            if (!isCityActive(a.dataset.cityKey)) a.remove();
        });
    });
}
...
if (typeof window !== 'undefined') {
  ...
  window.isCityActive = isCityActive;
}
